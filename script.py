...
class script:
    ...
    def init_driver(self):
        ...
        # chrome_options.add_argument(r"user-data-dir=C:\\Users\\alize\\AppData\\Local\\Google\\Chrome\\User Data") 
    ...
    def putData(self,data):
        ...
        self.driver.get("https://www.nordstromrack.com/s/sterling-forever-triple-layer-pendant-necklace/5994100")
        # time.sleep(500)
        ...
        # time.sleep(1)
        elem = self.driver.find_element_by_xpath('/html/body/div[1]/div/main/div/div[1]/div/div[2]/div[2]/div/div[6]/div[2]/div/button')
        elem.click()
        time.sleep(1)
        elem = self.driver.find_element_by_xpath('/html/body/div[1]/div/div/div/div/div/div[2]/div/div/div[2]/div/div/a')
        elem.click()
